...
In this Section, the usage of the MLT framework is explained with code examples. This is based on the implemented code for this project, the code of the MLT framework and the MLT documentation~\cite{melt}.
