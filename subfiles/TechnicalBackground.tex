...
\begin{description}[font=\normalfont\color{RedViolet!80!black}, style=nextline]
	...
	\item[Initialise the factory] if (mlt\_factory\_init(NULL))
	...
	mlt\_filter filter = mlt\_factory\_filter( "greyscale", NULL );
	
	\item[Connect elements] Beschreibung
	// Connect the filter to the producer and consumer to filter
	mlt\_filter\_connect( filter, mlt\_producer\_service( producer ), 0 );
