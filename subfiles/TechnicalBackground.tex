...
\begin{description}[font=\normalfont\color{RedViolet!80!black}, style=nextline]
	...
	\begin{lstlisting}[language=C, numbers=none]
		if (mlt_factory_init(NULL)) \end{lstlisting}
	...
	\begin{lstlisting}[language=C, numbers=none]
		mlt_consumer hello = mlt_factory_consumer(profile, NULL, NULL); \end{lstlisting}
	
	\item[Create a producer] Beschreibung
	
	\begin{lstlisting}[language=C, numbers=none]
	 mlt_producer world = mlt_factory_producer(profile, NULL, argv[1]); \end{lstlisting}
	...
	\begin{lstlisting}[language=C, numbers=none]
		 mlt_consumer_connect(hello, mlt_producer_service(world)); \end{lstlisting}
	
	\item[Start consumer] Beschreibung
	
	\begin{lstlisting}[language=C, numbers=none]
		mlt_consumer_start(hello);	\end{lstlisting}
	...
	\begin{lstlisting}[language=C, numbers=none]
	 mlt_consumer_close(hello); \end{lstlisting}
	
	\item[Close the producer] Beschreibung
	
	\begin{lstlisting}[language=C, numbers=none]
		mlt_producer_close(world); \end{lstlisting}
