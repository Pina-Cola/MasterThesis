...
In the following, the structure of the Melt framework will be briefly explained. For this, the documentation~\cite{melt}  as well as the code of the framework\myfootcite{melt_code} are taken into consideration.
