...
Node.js enables the execution of JavaScript code outside of a web browser.~\cite{nodejs, RM_Frontend, ap3_docs}



To manage project dependencies and packages, tools like Yarn or npm (Node Package Manager) can be used. These package managers allow developers to install, update, and manage libraries and tools used in the project.~\cite{RM_Frontend, npmyarn}



TODO

% Additionally, the \texttt{Session} service, built on Java, plays a crucial role in supporting machine-to-machine interaction between the browser and backend components such as \texttt{main.py} and Melt. By leveraging web services, \texttt{Session} enables seamless communication between applications running on different platforms and written in different programming languages.
