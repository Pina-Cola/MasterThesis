...
The result of the subtraction can be seen Figure~\ref{figure:gammagimp}. The Accurate Player frame was subtracted from the KDEN Live frame extraction. The result does not show green or blue areas, which shows that the KDEN Live frame has more or equally saturated red values than the Accurate Player frame extraction in all areas.
