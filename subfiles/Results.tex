...
In this Section, the results of video colour grading using the command line tool Melt and the in Section~\ref{subsection:implementation} described implementation with JIT are compared. 
