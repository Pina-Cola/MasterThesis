...
\begin{minipage}{0.48\textwidth}
	...
	\begin{figure}[H]
		\begin{center}
			...
			\caption[]{Frame 343 after the application of the maximum value for red in the Melt framework.}
...
\begin{figure}[H]
	\begin{center}
		...
		\caption[]{Subtraction of the same frame with filter application: Local Melt frame is subtracted from the frame of the Accurate Player.}
		% JIT - Melt
...
\begin{minipage}{0.48\textwidth}
	...
	\begin{figure}[H]
		\begin{center}
			...
			\caption[]{Frame 343 after the application of the maximum value for green in the Melt framework.}
			%\label{figure:redMelt}
		\end{center}
	\end{figure}
\end{minipage}\begin{minipage}{0.04\textwidth}
...
\begin{minipage}{0.48\textwidth}
	...
	\begin{figure}[H]
		\begin{center}
			...
			\caption[]{Frame 343 after the application of the maximum value for blue in the Melt framework.}
			%\label{figure:redMelt}
		\end{center}
	\end{figure}
\end{minipage}\begin{minipage}{0.04\textwidth}
