...
While those two processes are related, they serve different purposes and are typically performed at different stages of production.
%
...
\begin{minipage}{0.5\textwidth}
	\begin{figure}[H]
		\begin{center}
			...
			\caption[Picture of an Amanita muscaria in Sweden with alarming red colour.]{Picture of a Amanita muscaria with alarming red colour.}
			\label{figure:red}
		\end{center}
	\end{figure}
 \hfill
...
The instinctual reaction to red is used in various contexts, including traffic signals and emergency alarms, where the colour serves as a clear and universally understood signal~\cite{colour}.
...
\end{minipage}\begin{minipage}{0.5\textwidth}
	\begin{figure}[H]
		\begin{center}
			...
			\caption[Picture of a lake in Sweden with mainly blue tones.]{Picture of a lake with mainly blue tones.}
			\label{figure:blue}
		\end{center}
	\end{figure}\hfill
\end{minipage}
...
\begin{minipage}{0.5\textwidth}
	\begin{figure}[H]
		\begin{center}
			...
			\caption[Picture of a forest in Sweden with mainly green tones.]{Picture of a forest with mainly green tones.}
			\label{figure:green}
		\end{center}
	\end{figure}\hfill
\end{minipage}\begin{minipage}{0.05\textwidth}
...
\end{minipage}\begin{minipage}{0.5\textwidth}
	\begin{figure}[H]
		\begin{center}
			...
			\caption[Picture of a sunrise in Sweden with mainly yellow tones.]{Picture of a sunrise with mainly yellow tones.}
			\label{figure:yellow}
		\end{center}
	\end{figure}\hfill
\end{minipage}
...
%\vspace*{-0.6em}
\vspace*{-0.2em}
 of the buildings. Furthermore, black, white and greyscale are often used to convey elegance and clarity~\cite{colour2}.
...
RGB colour representation is a model that attempts to mathematically represent colours as perceived by human vision. RGB stands for Red, Green and Blue. 
...
Each pixel on a standard LCD display consists of three sub-pixels that each displays one of the colours red, green or blue. By adjusting the intensity of each sub-pixel, a wide range of colours can be achieved. 
The RGB value of a pixel indicates the amount of each colour. This means if for example the red value is set to 0, the red sub-pixel is turned off. When the red value is set to 255, the red sub-pixel is fully turned on~\cite{colourRGB, lcd}.
...
When subtracting one image from another, the RGB pixel values from one image are subtracted from the corresponding pixel values in the other image and an offset is added. 
...
\begin{figure}[H]
	...
	\includegraphics[width=0.6\textwidth]{lightMINUSneon1.png}
	\includegraphics[width=0.6\textwidth]{neonMINUSlight1.png}
...
Let $g$ be the \textit{grain extract} function in GIMP that adds 128 to two subtracted RGB values. The input values as well as the result are ranging from $0$ to $255$. The function is defined as follows:
%
\begin{align*}
...
The results are the light blue colour \texttt{RGB(75, 223, 223)} and the red tone \texttt{RGB(181, 33, 33)}, which can be seen in Figure~\ref{figure:neonminuslight}. 
