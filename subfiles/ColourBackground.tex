...
Each of those colour channels (red, green, and blue) has a value ranging from 0 to 255. When all three colours are at their maximum value $(255,255,255)$, the outcome is white. Conversely, when all three are at their minimum value $(0,0,0)$, the result is black.
