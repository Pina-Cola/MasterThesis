...
% neon = 0, 100, 100
% light = 0, 53, 79.2
% outcome red = 0, 82.2, 70.6
% outcome blue = 180, 66.8, 87.5
...
Let $g$ be the \textit{grain extract} function in GIMP that adds 128 to two subtracted RGB values. The function is defines as follows:
%
\begin{align*}
	g(x, y) = x - y + 128
\end{align*}
...
The following calculations are executed to retrieve the new values of the colours after the subtraction.
%
\begin{align*}
	\text{\texttt{RGB}}_1 - \text{\texttt{RGB}}_2 & = (g(R_1, R_2), g(G_1, G_2), g(B_1, B_2)) \\
	\text{\texttt{RGB}}_1 - \text{\texttt{RGB}}_2 & = ((R_1 - R_2 + 128), (G_1 - G_2 + 128) , (B_1 - B_2 + 128)) 
\end{align*}


For the examples, that are shown in Figure~\ref{figure:neonminuslight}, the calculations are shown in the following:
%
\begin{align*}
	\text{\texttt{RGB}}_1 & = (202, 95, 95) \ \ \ \ \ \ \ \ \ \ \ \ \ 
	\text{\texttt{RGB}}_2 = (255, 0, 0) \\
	\text{\texttt{RGB}}_1 - \text{\texttt{RGB}}_2 & = (g(202, 255), g(95, 0), g(95, 0)) \\
	\text{\texttt{RGB}}_1 - \text{\texttt{RGB}}_2 & = ((202 - 255 + 128), (95 - 0 + 128) , (95 - 0 + 128)) \\
	\text{\texttt{RGB}}_1 - \text{\texttt{RGB}}_2 & = (75, 223, 223) \\
	(75, 223, 223) \neq (74, 233, 233)
\end{align*}
