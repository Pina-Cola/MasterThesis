...
% RGB colour representation is a method computers employ to display colours on screens, such as those found on TVs, computers, and smartphones. It stands for Red, Green, and Blue. These three colours are combined in varying proportions to generate a broad spectrum of colours.

% Each colour channel – red, green, and blue – has a value ranging from 0 to 255. When all three colours are at their maximum value (255), the outcome is white. Conversely, when all three are at their minimum value (0), the result is black.

% For instance, if you mix full red (255 in the red channel), no green (0 in the green channel), and no blue (0 in the blue channel), you achieve pure red. Similarly, combining full green with no red or blue yields pure green, while full blue with no red or green produces pure blue.
