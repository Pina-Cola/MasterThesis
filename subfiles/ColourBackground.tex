...
\begin{tikzpicture}
	...
	% Define the circles
	\fill[red] (0,-2.5) circle (2cm);
	\fill[green!80!black] (4,-2.5) circle (2cm);
	\fill[blue] (2,1.732) circle (2cm);
	
	% Define the overlapping areas
	\begin{scope}[blend mode=multiply]
		\fill[cyan] (2,1.732) circle (2cm);
		\fill[yellow] (4,-2.5) circle (2cm);
		\fill[magenta] (0,-2.5) circle (2cm);
	\end{scope}
	
	% Add labels
	\node[below] at (0,-4.5) {Red};
	\node[below] at (4,-4.5) {Green};
	\node[below] at (2,2.732) {Blue};
	
	\node[above right] at (0,-2.5) {Magenta};
	\node[above right] at (4,-2.5) {Yellow};
	\node[above right] at (2,1.732) {Cyan};
