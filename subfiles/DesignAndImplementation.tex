...
For this purpose, various MLT filters are examined and compared to identify the most suitable ones for implementing this functionality. 
...
%\texttt{av\-fil\-ter.\-col\-or\-bal\-ance}, 
%\texttt{av\-fil\-ter.\-col\-or\-chan\-nel\-mix\-er},
%\texttt{av\-fil\-ter.\-col\-or\-con\-trast},
%\texttt{av\-fil\-ter.\-col\-or\-cor\-rect},
%\texttt{av\-fil\-ter.\-col\-or\-hold},
%\texttt{av\-fil\-ter.\-col\-or\-ize},
%\texttt{av\-fil\-ter.\-col\-or\-key},
%\texttt{av\-fil\-ter.\-col\-or\-lev\-els},
%\texttt{av\-fil\-ter.\-col\-or\-ma\-trix},
%\texttt{av\-fil\-ter.\-col\-or\-space},
%\texttt{av\-fil\-ter.\-col\-or\-tem\-per\-ature},
%\texttt{frei\-0r.\-col\-or\-adj\-\_RGB} and
%\texttt{frei\-0r.\-col\-or\-ize}.
%
%The three filters \texttt{av\-fil\-ter.\-col\-or\-bal\-ance}, \texttt{av\-fil\-ter.\-col\-or\-chan\-nel\-mix\-er} and \texttt{frei\-0r.\-col\-or\-adj\_RGB} are selected for further analysis, because their capabilities align best with the requirements for RGB colour adjustment with sliders.
...
\begin{table}[H]
	...
	\texttt{avfilter.colorcontrast} & Adjust colour contrast between RGB components & Only contrast can be adjusted, not the RGB values \\ 
	...
	\texttt{avfilter.colortemperature} & Adjust colour temperature & Rejected: Not suitable for RGB adjustment \\ s
...
% They are listed with their description and parameters in Table~\ref{table:filter}, followed by a comparison of the visual results.
...
%
%To be able to apply multiple non-zero values for the three different colour channels at once, the command needs to be sent to MLT with all of the appropriate parameters set. 
%Otherwise the other parameters will be overwritten with the default value $0$. 
%This refers to the achieving of mixed colour results, including for example yellow, which can be created by adjusting the red and the green colour channel, meaning colours that have a non-zero RGB value for more than one of the three colour channels. 
%If the filter is applied with a change in one of the RGB colour channels, the other two channels get overwritten by the default value of zero. 
...
For the implementation, global variables are initialized for each of the colours that are set to the current value in each call. This can be seen in the code snippet above and prevents the overwriting of the previously adjusted values with the default value of zero.
