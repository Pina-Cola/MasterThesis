...
AVI is a file format that can contain audio and video information to allow synchronized playback of audio and video components.~\cite{avi} AVI and names pipes were further described in Section~\ref{subsection_OverviewVideoStreamingComponents}.
...
The \texttt{Session} service exposes a REST API (described in Section~\ref{subsection_OverviewVideoStreamingComponents}) for initiating a JIT session with specified media details. 
