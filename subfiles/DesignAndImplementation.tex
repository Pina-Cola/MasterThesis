...
TODO: formats of JIT, describe JIT situation

%  With Accurate Player JIT, it becomes feasible to play formats like mxf and prores directly in web browsers, bypassing the necessity of converting them into web-friendly formats beforehand.

% And also, that by performing color grading/correction directly on formats that supports larger bit depths, wider color gamuts etc before they are converted to a web friendly format we can achieve a better result with more precision.


TODO: write about quality slider in the context of JIT
