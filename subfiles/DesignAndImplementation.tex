...
\begin{figure}[H]
	\begin{tabular}{c|c|c}
		...
		\cutpic{0.3cm}{0.3\textwidth}{cb_yellow.png} & \cutpic{0.3cm}{0.3\textwidth}{rrgg_snow.png} & \cutpic{0.3cm}{0.3\textwidth}{rg_snow.png} \\
		
		\cutpic{0.3cm}{0.3\textwidth}{cb_yellow_man.png} & \cutpic{0.3cm}{0.3\textwidth}{rrgg_man.png} & \cutpic{0.3cm}{0.3\textwidth}{rg_man.png} \\
