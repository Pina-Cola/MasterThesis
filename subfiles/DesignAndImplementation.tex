...
%the av.colorbalance filter has the most vibrent and intense results and it has the option to adapt the shadows, mid tones and highlights inidvidually and that opens nice options for more adjustment of the results in the backend and future work for adjustment on the user side
%but on the downside to tone the whole frame red, 3 instead of 1 parameter have to be applied but in usage of this with jit there was no noticable performance difference and to really know this, tests would have to be performed and the implementations of the filters to be checked
