...
\begin{document}
	...
	The different applications for comparison, that use the MLT framework as a backend are the command line video editor Melt and the video editing software KDEN Live. 
