...
\begin{document}
	...
	\begin{itemize}
		...
		\item[\textbf{\ref{section:systemrequirementsandspecifications}}] This Chapter outlines the system requirements and specifications for the system to be able to execute the code.
		
		\item[\textbf{\ref{section:designandimplementation}}] Design and Implementation are described in this Chapter. The architecture of the system is introduced, describing the frontend and backend of the system: Accurate Player and JIT-WebRTC. Furthermore, different Melt filters for RGB adjustment are tested and compared and the execution of the code and the implementation of the RGB adjustment is described.
