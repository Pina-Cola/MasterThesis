...
\newpage	
	...
	\begin{description}[font=\color{RedViolet!80!black}, style=nextline]
		...
		%
		For this, information directly from the Melt website itself was consulted. 
		%
		...
		% 
		Additionally, the code of the Melt framework was examined.~\cite{melt, melt_filters, melt_code} 
		%
