...
\begin{document}
	...
	\begin{researchbox}
		Is there variation in the outcomes of filter applications across various applications with a Melt backend and the specified system?
	\end{researchbox}
...
\newpage	
	...
	\begin{description}[font=\color{RedViolet!80!black}, style=nextline]
		...
		%
		Especially the list of different Melt filters was considered, to compare the Melt filters and select the most suitable option for the RGB adjustment and
		% 
		the code of the Melt framework was examined~\cite{melt_filters, melt_code}.
		%
