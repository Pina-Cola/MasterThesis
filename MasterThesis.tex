...
The colour red is often associated with intense emotions such as passion, excitement, and danger. In visual media, the use of red can evoke feelings of urgency, power, and love. For example a video with flashes of red light may create a feeling of tension or alarm.
...
\begin{figure}[H]
	\begin{center}
		\cutpic{0.3cm}{0.5\textwidth}{sunset.jpg}
		\label{figure:yellow}
