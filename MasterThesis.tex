...
\begin{minipage}{0.4\textwidth}
	...
	%Blue light has been shown to increase subjective alertness and performance on attention-based tasks
	
	% Blue stores/logos have been shown to increase quality and trustworthiness appraisals
\end{minipage}\begin{minipage}{0.02\textwidth}
\ 
