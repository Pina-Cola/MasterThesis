...
Codemill was originally founded in 2007. \cite{codemill_old, codemill_now}
...
%Our Accurate.Video cloud native software is used by the Worlds leading studios, broadcasters and media service providers, for asset versioning QC/QA, content segmentation and poster image preparation for AVOD/SVOD and FAST channels.

%Accurate.Video is deeply integrated with leading content management platforms and cloud services, including Amazon Web Services, our own Cantemo Media Asset Management software, Technology & Engineering Emmy award winning Vidispine media backbone APIs and the SDVI Rally Access platform.


% Frida

% This master thesis was done in collaboration with Codemill [5]. Codemill was founded in 2007 and is a digital product development- and IT-Consult company that is located in Umea, Sweden. They work with many international companies, mostly in the media and broadcast industries. The company has produced many products, one of the main products is called Accurate Video


Test \cite{frida} and \cite{codemill} and \cite{codemill_linkedin} 
