...
\newpage
\section{Solutions in Melt Framework?} \label{appendix:solutionsinmeltframework}




\subsubsection*{MLT FX}
...
\begin{itemize}
	...
	\item[]
	\item Can MLT FX be used in the terminal/through commands or is it an application with UI only?
	\item Look into \url{https://www.mltframework.org/docs/fxcut/}? on FX Cut (but this page is fro 2005)
	...
	\item Promising sounding filters to analyse:
	\begin{itemize}
		%\item BurningTV?
		%\item autofade?
		%\item avcolour_space and avcolor_space (FFmpeg Image Converter)
		\item avfilter.colorbalance
		\item avfilter.colorchannelmixer
		\item avfilter.colorcontrast
		\item avfilter.colorcorrect
		\item avfilter.colorize
		\item avfilter.colorkey
		\item avfilter.colorlevels
		\item avfilter.colormatrix
		\item avfilter.colorspace
		\item avfilter.colortemperature
		\item avfilter.pseudocolor
		\item avfilter.selectivecolor
		\item[]
		\item frei0r.coloradj\_RGB
		\item frei0r.colordistance
		\item frei0r.colorhalftone
		\item frei0r.colorize
