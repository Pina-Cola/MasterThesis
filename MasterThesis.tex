...
%The color red is often associated with intense emotions such as passion, excitement, and danger. In visual media, the use of red can evoke feelings of urgency, power, and love. For example, a picture featuring a vibrant red sunset can convey a sense of warmth and romance, while a video with flashes of red light may create a feeling of tension or alarm.

%\subsection{Blue}

%Blue is commonly linked to feelings of calmness, tranquility, and stability. In videos and pictures, the presence of blue tones can create a sense of serenity and relaxation. For instance, a photograph of a tranquil ocean scene with shades of blue can evoke a peaceful mood, while a video featuring blue-tinted lighting may impart a sense of introspection or contemplation.

%\subsection{Green}

%Green is associated with nature, growth, and harmony. In visual media, the use of green can symbolize renewal, freshness, and balance. For example, a picture showcasing lush green landscapes can evoke feelings of vitality and rejuvenation, while a video featuring green foliage may convey a sense of natural beauty and harmony.
...
\begin{figure}[H]
	\begin{center}
		\cutpic{0.3cm}{0.6\textwidth}{sunset.jpg}
		\label{figure:yellow}
...
%Black and white are often used to evoke a sense of timelessness, simplicity, and sophistication. In visual media, the absence of color can draw attention to shapes, textures, and contrasts. For example, a black and white photograph of a city skyline can emphasize the architectural details and create a dramatic atmosphere, while a black and white video may evoke a sense of nostalgia or nostalgia.
