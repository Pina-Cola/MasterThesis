...
\begin{titlepage}	
	...
	\begin{tabularx}{\linewidth}{@{}lXr@{}}
		\makecell{\hspace*{2em}\includegraphics[height=1.5cm]{umu.png}}
		& &\makecell{\includegraphics[height=0.7cm]{codemill.png}}\\
	\end{tabularx}\\%
	\vfill
	%
	%\hspace*{-4em}\vspace*{-6em}\includegraphics[width=0.3\textwidth]{codemill.png} \hfill \includegraphics[width=0.1\textwidth]{umu.png} \par
	%\vspace*{6em}
