...
JIT-WebRTC is a live transcoder with a WebRTC output that is run in a docker container.~\cite{RM_Backend} As described in Section~\ref{subsection:videotranscoding}, transcoding is the conversion of one digital data format into another.~\cite{transcoding}
