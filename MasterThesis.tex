...
JIT-WebRTC is a live transcoder with a WebRTC output that is run in a docker container.~\cite{RM_Backend} Transcoding is the conversion of one digital data format into another.~\cite{transcoding}
...
\includegraphics[page=1, width=0.95\textwidth]{FE.pdf}

\includegraphics[page=2, width=0.95\textwidth]{FE.pdf}
...
\includegraphics[page=1, width=1\textwidth]{BE.pdf}

\includegraphics[page=2, width=1\textwidth]{BE.pdf}
