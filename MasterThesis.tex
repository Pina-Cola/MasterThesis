...
\begin{abstract}
	...
	\noindent This thesis project lays in the field of real-time multimedia processing, focusing on the user sided adjustment of RGB values in  video streaming using JIT and the Melt framework. 
	This is implemented in Codemill's Accurate Player and using WebRTC as a data channel.
...
\begin{adjustbox}{width=1\textwidth}
	\begin{tabular}{llll}
		 $\blacktriangleright$~Multimedia~processing & $\blacktriangleright$~RGB~colour~adjustment & $\blacktriangleright$~Colour~grading & $\blacktriangleright$~Melt~framework \\
		 $\blacktriangleright$~Melt~filter $\blacktriangleright$~Real-time & $\blacktriangleright$~Just-in-time $\blacktriangleright$~WebRTC &  $\blacktriangleright$~Codemill & $\blacktriangleright$~Accurate~Player \\
		 \ & \ & \ & \ \\
...
\end{comment}
	...
	\begin{comment}
	\mbox{$\blacktriangleright$~Multimedia~processing}
	\mbox{$\blacktriangleright$~RGB~colour~adjustment}
	\mbox{$\blacktriangleright$~Colour~grading}
	\mbox{$\blacktriangleright$~Melt~framework} 
	\mbox{$\blacktriangleright$~Melt~filter}
	\mbox{$\blacktriangleright$~Real-time}
	\mbox{$\blacktriangleright$~Just-in-time} 
	\mbox{$\blacktriangleright$~WebRTC}
	\mbox{$\blacktriangleright$~Codemill} 
	\mbox{$\blacktriangleright$~Accurate~Player} 
	\end{comment}

% \end{itemize}


% \mbox{$\blacktriangleright$~JIT-WebRTC}
% \mbox{$\blacktriangleright$~Protocol~buffer}
% \mbox{$\blacktriangleright$~RGB}
% \mbox{$\blacktriangleright$~GIMP~grain~extract}
% \mbox{$\blacktriangleright$~KDEN~Live} 
